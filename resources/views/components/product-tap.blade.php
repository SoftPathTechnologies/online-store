                                ...
                                <div class="ec-sidebar-wrap">
                                    ...
                                    <div class="ec-sidebar-block">
                                        ...
                                        <div class="ec-sb-block-content">
                                            <ul>
                                                <li>
                                                    <div class="ec-sidebar-block-item"><img src="{{ asset('images/icons/dress-8.svg') }}" class="svg_img" alt="drink" />Cothes</div>
                                        ...
                                        <div class="ec-sb-block-content">
                                            <ul>
                                                <li>
                                                    <div class="ec-sidebar-block-item"><img src="{{ asset('images/icons/shoes-8.svg') }}" class="svg_img" alt="drink" />Footwear</div>
                                                    <ul>
                                                        <li>
                                        ...
                                        <div class="ec-sb-block-content">
                                            <ul>
                                                <li>
                                                    <div class="ec-sidebar-block-item"><img src="{{ asset('images/icons/jewelry-8.svg') }}" class="svg_img" alt="drink" />jewelry</div>
                                                    <ul>
                                                        <li>
                                        ...
                                        <div class="ec-sb-block-content">
                                            <ul>
                                                <li>
                                                    <div class="ec-sidebar-block-item"><img src="{{ asset('images/icons/perfume-8.svg') }}" class="svg_img" alt="drink" />perfume</div>
                                                    <ul>
                                                        <li>
                                        ...
                                        <div class="ec-sb-block-content">
                                            <ul>
                                                <li>
                                                    <div class="ec-sidebar-block-item"><img src="{{ asset('images/icons/cosmetics-8.svg') }}" class="svg_img" alt="drink" />cosmetics</div>
                                                    <ul>
                                                        <li>
                                        ...
                                        <div class="ec-sb-block-content">
                                            <ul>
                                                <li>
                                                    <div class="ec-sidebar-block-item"><img src="{{ asset('images/icons/glasses-8.svg') }}" class="svg_img" alt="drink" />glasses</div>
                                                    <ul>
                                                        <li>
                                        ...
                                        <div class="ec-sb-block-content">
                                            <ul>
                                                <li>
                                                    <div class="ec-sidebar-block-item"><img src="{{ asset('images/icons/bag-8.svg') }}" class="svg_img" alt="drink" />bags</div>
                                                    <ul>
                                                        <li>
                            ...
                            <div class="ec-sidebar-slider">
                                ...
                                <div class="ec-sb-pro-sl">
                                    <div>
                                        <div class="ec-sb-pro-sl-item">
                                            <a href="product-left-sidebar.html" class="sidekka_pro_img"><img
                                                    src="{{ asset('images/product-image/1.jpg') }}" alt="product" /></a>
                                    ...
                                    <div>
                                        <div class="ec-sb-pro-sl-item">
                                            <a href="product-left-sidebar.html" class="sidekka_pro_img"><img
                                                    src="{{ asset('images/product-image/2.jpg') }}" alt="product" /></a>
                                            <div class="ec-pro-content">
                                    ...
                                    <div>
                                        <div class="ec-sb-pro-sl-item">
                                            <a href="product-left-sidebar.html" class="sidekka_pro_img"><img
                                                    src="{{ asset('images/product-image/3.jpg') }}" alt="product" /></a>
                                            <div class="ec-pro-content">
                                    ...
                                    <div>
                                        <div class="ec-sb-pro-sl-item">
                                            <a href="product-left-sidebar.html" class="sidekka_pro_img"><img
                                                    src="{{ asset('images/product-image/4.jpg') }}" alt="product" /></a>
                                            <div class="ec-pro-content">
                                    ...
                                    <div>
                                        <div class="ec-sb-pro-sl-item">
                                            <a href="product-left-sidebar.html" class="sidekka_pro_img"><img
                                                    src="{{ asset('images/product-image/5.jpg') }}" alt="product" /></a>
                                            <div class="ec-pro-content">
                                    ...
                                    <div>
                                        <div class="ec-sb-pro-sl-item">
                                            <a href="product-left-sidebar.html" class="sidekka_pro_img"><img
                                                    src="{{ asset('images/product-image/6.jpg') }}" alt="product" /></a>
                                            <div class="ec-pro-content">
                                    ...
                                    <div>
                                        <div class="ec-sb-pro-sl-item">
                                            <a href="product-left-sidebar.html" class="sidekka_pro_img"><img
                                                    src="{{ asset('images/product-image/7.jpg') }}" alt="product" /></a>
                                            <div class="ec-pro-content">
                                        ...
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image" src="{{ asset('images/product-image/88_1.jpg') }}"
                                                        alt="Product" />
                                                </a>
                                            </div>
                                        </div>
                                ...
                                <div class="col-sm-12 ec-all-product-block">
                                    <div class="ec-all-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image" src="{{ asset('images/product-image/89_1.jpg') }}"
                                                        alt="Product" />
                                                </a>
                                            </div>
                                        </div>
                                ...
                                <div class="col-sm-12 ec-all-product-block">
                                    <div class="ec-all-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image" src="{{ asset('images/product-image/90_1.jpg') }}"
                                                        alt="Product" />
                                                </a>
                                            </div>
                                        </div>
                                ...
                                <div class="col-sm-12 ec-all-product-block">
                                    <div class="ec-all-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image" src="{{ asset('images/product-image/91_1.jpg') }}"
                                                        alt="Product" />
                                                </a>
                                            </div>
                                        </div>
                                ...
                                <div class="col-sm-12 ec-all-product-block">
                                    <div class="ec-all-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image" src="{{ asset('images/product-image/92_1.jpg') }}"
                                                        alt="Product" />
                                                </a>
                                            </div>
                                        </div>
                                ...
                                <div class="col-sm-12 ec-all-product-block">
                                    <div class="ec-all-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image" src="{{ asset('images/product-image/93_1.jpg') }}"
                                                        alt="Product" />
                                                </a>
                                            </div>
                                        </div>
                                ...
                                <div class="col-sm-12 ec-all-product-block">
                                    <div class="ec-all-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image" src="{{ asset('images/product-image/94_1.jpg') }}"
                                                        alt="Product" />
                                                </a>
                                            </div>
                                        </div>
                                ...
                                <div class="col-sm-12 ec-all-product-block">
                                    <div class="ec-all-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image" src="{{ asset('images/product-image/95_1.jpg') }}"
                                                        alt="Product" />
                                                </a>
                                            </div>
                                        </div>
                                ...
                                <div class="col-sm-12 ec-all-product-block">
                                    <div class="ec-all-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image" src="{{ asset('images/product-image/96_1.jpg') }}"
                                                        alt="Product" />
                                                </a>
                                            </div>
                                        </div>
                                ...
                                <div class="col-sm-12 ec-all-product-block">
                                    <div class="ec-all-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image" src="{{ asset('images/product-image/97_1.jpg') }}"
                                                        alt="Product" />
                                                </a>
                                            </div>
                                        </div>
                                ...
                                <div class="col-sm-12 ec-all-product-block">
                                    <div class="ec-all-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image" src="{{ asset('images/product-image/98_1.jpg') }}"
                                                        alt="Product" />
                                                </a>
                                            </div>
                                        </div>
                                ...
                                <div class="col-sm-12 ec-all-product-block">
                                    <div class="ec-all-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image" src="{{ asset('images/product-image/99_1.jpg') }}"
                                                        alt="Product" />
                                                </a>
                                            </div>
                                        </div>
                                ...
                                <div class="col-sm-12 ec-all-product-block">
                                    <div class="ec-all-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image" src="{{ asset('images/product-image/100_1.jpg') }}"
                                                        alt="Product" />
                                                </a>
                                            </div>
                                        </div>
                                ...
                                <div class="col-sm-12 ec-all-product-block">
                                    <div class="ec-all-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image" src="{{ asset('images/product-image/101_1.jpg') }}"
                                                        alt="Product" />
                                                </a>
                                            </div>
                                        </div>
                                ...
                                <div class="col-sm-12 ec-all-product-block">
                                    <div class="ec-all-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image" src="{{ asset('images/product-image/102_1.jpg') }}"
                                                        alt="Product" />
                                                </a>
                                            </div>
                                        </div>
                                ...
                                <div class="col-sm-12 ec-all-product-block">
                                    <div class="ec-all-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image" src="{{ asset('images/product-image/103_1.jpg') }}"
                                                        alt="Product" />
                                                </a>
                                            </div>
                                        </div>
                                ...
                                <div class="col-sm-12 ec-all-product-block">
                                    <div class="ec-all-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image" src="{{ asset('images/product-image/112_1.jpg') }}"
                                                        alt="Product" />
                                                </a>
                                            </div>
                                        </div>
                                ...
                                <div class="col-sm-12 ec-all-product-block">
                                    <div class="ec-all-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image" src="{{ asset('images/product-image/105_1.jpg') }}"
                                                        alt="Product" />
                                                </a>
                                            </div>
                                        </div>
                                ...
                                <div class="col-sm-12 ec-all-product-block">
                                    <div class="ec-all-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image" src="{{ asset('images/product-image/110_1.jpg') }}"
                                                        alt="Product" />
                                                </a>
                                            </div>
                                        </div>
                                ...
                                <div class="col-sm-12 ec-all-product-block">
                                    <div class="ec-all-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image" src="{{ asset('images/product-image/111_1.jpg') }}"
                                                        alt="Product" />
                                                </a>
                                            </div>
                                        </div>
                                ...
                                <div class="col-sm-12 ec-all-product-block">
                                    <div class="ec-all-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image" src="{{ asset('images/product-image/106_1.jpg') }}"
                                                        alt="Product" />
                                                </a>
                                            </div>
                                        </div>
                                ...
                                <div class="col-sm-12 ec-all-product-block">
                                    <div class="ec-all-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image" src="{{ asset('images/product-image/107_1.jpg') }}"
                                                        alt="Product" />
                                                </a>
                                            </div>
                                        </div>
                                ...
                                <div class="col-sm-12 ec-all-product-block">
                                    <div class="ec-all-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image" src="{{ asset('images/product-image/108_1.jpg') }}"
                                                        alt="Product" />
                                                </a>
                                            </div>
                                        </div>
                                ...
                                <div class="col-sm-12 ec-all-product-block">
                                    <div class="ec-all-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image" src="{{ asset('images/product-image/109_1.jpg') }}"
                                                        alt="Product" />
                                                </a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="ec-spe-pro-inner">
                                        <div class="ec-spe-pro-image-outer col-md-6 col-sm-12">
                                            <div class="ec-spe-pro-image">
                                                <img class="img-responsive" src="{{ asset('images/product-image/111_1.jpg') }}" alt="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="ec-spe-pro-image-outer col-md-6 col-sm-12">
                                            <div class="ec-spe-pro-image">
                                                <img class="img-responsive"
                                                            src="{{ asset('images/product-image/110_1.jpg') }}" alt="">
                                            </div>
                                        </div>
                                        <div class="ec-spe-pro-content col-md-6 col-sm-12">
                                            <div class="ec-spe-pro-rating">
                                                    ...
                                                    <div class="ec-pro-image">
                                                        <a href="product-left-sidebar.html" class="image">
                                                            <img class="main-image"
                                                                src="{{ asset('images/product-image/88_1.jpg') }}" alt="Product" />
                                                        ...
                                                        <div class="ec-pro-actions">
                                                            <a class="ec-btn-group wishlist" title="Wishlist"><img
                                                                    src="{{ asset('images/icons/pro_wishlist.svg') }}"
                                                                    class="svg_img pro_svg" alt="" /></a>
                                                            <a href="#" class="ec-btn-group quickview"
                                                                data-link-action="quickview" title="Quick view"
                                                                data-bs-toggle="modal" data-bs-target="#ec_quickview_modal"><img
                                                                    src="{{ asset('images/icons/quickview.svg') }}"
                                                                    class="svg_img pro_svg" alt="" /></a>
                                                            <a href="compare.html" class="ec-btn-group compare"
                                                                title="Compare"><img src="{{ asset('images/icons/compare.svg') }}"
                                                                    class="svg_img pro_svg" alt="" /></a>
                                                            <a href="javascript:void(0)"  title="Add To Cart" class="ec-btn-group add-to-cart"><img src="{{ asset('images/icons/pro_cart.svg') }}"
                                                                        class="svg_img pro_svg" alt="" /></a>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="ec-product-inner">
                                                <div class="ec-pro-image-outer">
                                                    <div class="ec-pro-image">
                                                        <a href="product-left-sidebar.html" class="image">
                                                            <img class="main-image"
                                                                src="{{ asset('images/product-image/97_1.jpg') }}" alt="Product" />
                                                            <img class="hover-image"
                                                                src="{{ asset('images/product-image/97_2.jpg') }}" alt="Product" />
                                                        </a>
                                                        <div class="ec-pro-actions">
                                                            <a class="ec-btn-group wishlist" title="Wishlist"><img
                                                                    src="{{ asset('images/icons/pro_wishlist.svg') }}"
                                            ...
                                            <div class="ec-product-inner">
                                                <div class="ec-pro-image-outer">
                                                    <div class="ec-pro-image">
                                                        <a href="product-left-sidebar.html" class="image">
                                                            <img class="main-image"
                                                                src="{{ asset('images/product-image/107_1.jpg') }}" alt="Product" />
                                                            <img class="hover-image"
                                                                src="{{ asset('images/product-image/107_1.jpg') }}" alt="Product" />
                                                        </a>
                                                        <span class="flags">
                                            ...
                                            <div class="ec-product-inner">
                                                <div class="ec-pro-image-outer">
                                                    <div class="ec-pro-image">
                                                        <a href="product-left-sidebar.html" class="image">
                                                            <img class="main-image"
                                                                src="{{ asset('images/product-image/108_1.jpg') }}" alt="Product" />
                                                            <img class="hover-image"
                                                                src="{{ asset('images/product-image/108_1.jpg') }}" alt="Product" />
                                                        </a>
                                                        <span class="flags">
                                            ...
                                            <div class="ec-product-inner">
                                                <div class="ec-pro-image-outer">
                                                    <div class="ec-pro-image">
                                                        <a href="product-left-sidebar.html" class="image">
                                                            <img class="main-image"
                                                                src="{{ asset('images/product-image/110_1.jpg') }}" alt="Product" />
                                                            <img class="hover-image"
                                                                src="{{ asset('images/product-image/110_1.jpg') }}" alt="Product" />
                                                        </a>
                                                        <span class="flags">
                                            ...
                                            <div class="ec-product-inner">
                                                <div class="ec-pro-image-outer">
                                                    <div class="ec-pro-image">
                                                        <a href="product-left-sidebar.html" class="image">
                                                            <img class="main-image"
                                                                src="{{ asset('images/product-image/94_1.jpg') }}" alt="Product" />
                                                            <img class="hover-image"
                                                                src="{{ asset('images/product-image/94_2.jpg') }}" alt="Product" />
                                                        </a>
                                            ...
                                            <div class="ec-product-inner">
                                                <div class="ec-pro-image-outer">
                                                    <div class="ec-pro-image">
                                                        <a href="product-left-sidebar.html" class="image">
                                                            <img class="main-image"
                                                                src="{{ asset('images/product-image/98_1.jpg') }}" alt="Product" />
                                                            <img class="hover-image"
                                                                src="{{ asset('images/product-image/98_2.jpg') }}" alt="Product" />
                                                        </a>
                                                        <span class="flags">
                                                            <span class="sale">Sale</span>
                                                        </span>
                                            ...
                                            <div class="ec-product-inner">
                                                <div class="ec-pro-image-outer">
                                                    <div class="ec-pro-image">
                                                        <a href="product-left-sidebar.html" class="image">
                                                            <img class="main-image"
                                                                src="{{ asset('images/product-image/111_1.jpg') }}" alt="Product" />
                                                            <img class="hover-image"
                                                                src="{{ asset('images/product-image/111_1.jpg') }}" alt="Product" />
                                                        </a>
                                                        <div class="ec-pro-actions">
                                            ...
                                            <div class="ec-product-inner">
                                                <div class="ec-pro-image-outer">
                                                    <div class="ec-pro-image">
                                                        <a href="product-left-sidebar.html" class="image">
                                                            <img class="main-image"
                                                                src="{{ asset('images/product-image/95_1.jpg') }}" alt="Product" />
                                                            <img class="hover-image"
                                                                src="{{ asset('images/product-image/95_2.jpg') }}" alt="Product" />
                                                        </a>
                                                        <span class="flags">
                                                            <span class="sale">Sale</span>
                                                        </span>
                                            ...
                                            <div class="ec-product-inner">
                                                <div class="ec-pro-image-outer">
                                                    <div class="ec-pro-image">
                                                        <a href="product-left-sidebar.html" class="image">
                                                            <img class="main-image"
                                                                src="{{ asset('images/product-image/89_1.jpg') }}" alt="Product" />
                                                            <img class="hover-image"
                                                                src="{{ asset('images/product-image/89_1.jpg') }}" alt="Product" />
                                                        </a>
                                                        <span class="flags">
                                            ...
                                            <div class="ec-product-inner">
                                                <div class="ec-pro-image-outer">
                                                    <div class="ec-pro-image">
                                                        <a href="product-left-sidebar.html" class="image">
                                                            <img class="main-image"
                                                                src="{{ asset('images/product-image/90_1.jpg') }}" alt="Product" />
                                                            <img class="hover-image"
                                                                src="{{ asset('images/product-image/90_2.jpg') }}" alt="Product" />
                                                        </a>
                                                        <span class="flags">
                                                            <span class="new">New</span>
                                                        </span>
                                            ...
                                            <div class="ec-product-inner">
                                                <div class="ec-pro-image-outer">
                                                    <div class="ec-pro-image">
                                                        <a href="product-left-sidebar.html" class="image">
                                                            <img class="main-image"
                                                                src="{{ asset('images/product-image/91_1.jpg') }}" alt="Product" />
                                                            <img class="hover-image"
                                                                src="{{ asset('images/product-image/91_2.jpg') }}" alt="Product" />
                                                        </a>
                                                        <span class="flags">
                                                            <span class="sale">Sale</span>
                                                        </span>
                                            ...
                                            <div class="ec-product-inner">
                                                <div class="ec-pro-image-outer">
                                                    <div class="ec-pro-image">
                                                        <a href="product-left-sidebar.html" class="image">
                                                            <img class="main-image"
                                                                src="{{ asset('images/product-image/92_1.jpg') }}" alt="Product" />
                                                            <img class="hover-image"
                                                                src="{{ asset('images/product-image/92_2.jpg') }}" alt="Product" />
                                                        </a>
                                                        <div class="ec-pro-actions">
                                                            <a class="ec-btn-group wishlist" title="Wishlist"><img
                                                                    src="{{ asset('images/icons/pro_wishlist.svg') }}"
                                            ...
                                            <div class="ec-product-inner">
                                                <div class="ec-pro-image-outer">
                                                    <div class="ec-pro-image">
                                                        <a href="product-left-sidebar.html" class="image">
                                                            <img class="main-image"
                                                                src="{{ asset('images/product-image/93_1.jpg') }}" alt="Product" />
                                                            <img class="hover-image"
                                                                src="{{ asset('images/product-image/93_2.jpg') }}" alt="Product" />
                                                        </a>
                                                        <div class="ec-pro-actions">
                                                            <a class="ec-btn-group wishlist" title="Wishlist"><img
                                                                    src="{{ asset('images/icons/pro_wishlist.svg') }}"
                                            ...
                                            <div class="ec-product-inner">
                                                <div class="ec-pro-image-outer">
                                                    <div class="ec-pro-image">
                                                        <a href="product-left-sidebar.html" class="image">
                                                            <img class="main-image"
                                                                src="{{ asset('images/product-image/96_1.jpg') }}" alt="Product" />
                                                            <img class="hover-image"
                                                                src="{{ asset('images/product-image/96_2.jpg') }}" alt="Product" />
                                                        </a>
                                                        <div class="ec-pro-actions">
                                                            <a class="ec-btn-group wishlist" title="Wishlist"><img
                                                                    src="{{ asset('images/icons/pro_wishlist.svg') }}"
                                            ...
                                            <div class="ec-product-inner">
                                                <div class="ec-pro-image-outer">
                                                    <div class="ec-pro-image">
                                                        <a href="product-left-sidebar.html" class="image">
                                                            <img class="main-image"
                                                                src="{{ asset('images/product-image/99_1.jpg') }}" alt="Product" />
                                                            <img class="hover-image"
                                                                src="{{ asset('images/product-image/99_1.jpg') }}" alt="Product" />
                                                        </a>
                                                        <span class="flags">
                                            ...
                                            <div class="ec-product-inner">
                                                <div class="ec-pro-image-outer">
                                                    <div class="ec-pro-image">
                                                        <a href="product-left-sidebar.html" class="image">
                                                            <img class="main-image"
                                                                src="{{ asset('images/product-image/100_1.jpg') }}" alt="Product" />
                                                            <img class="hover-image"
                                                                src="{{ asset('images/product-image/100_1.jpg') }}" alt="Product" />
                                                        </a>
                                                        <span class="flags">
                                            ...
                                            <div class="ec-product-inner">
                                                <div class="ec-pro-image-outer">
                                                    <div class="ec-pro-image">
                                                        <a href="product-left-sidebar.html" class="image">
                                                            <img class="main-image"
                                                                src="{{ asset('images/product-image/104_1.jpg') }}" alt="Product" />
                                                            <img class="hover-image"
                                                                src="{{ asset('images/product-image/104_2.jpg') }}" alt="Product" />
                                                        </a>
                                                        <div class="ec-pro-actions">
                                                            <a class="ec-btn-group wishlist" title="Wishlist"><img
                                                                    src="{{ asset('images/icons/pro_wishlist.svg') }}"
                                            ...
                                            <div class="ec-product-inner">
                                                <div class="ec-pro-image-outer">
                                                    <div class="ec-pro-image">
                                                        <a href="product-left-sidebar.html" class="image">
                                                            <img class="main-image"
                                                                src="{{ asset('images/product-image/102_1.jpg') }}" alt="Product" />
                                                            <img class="hover-image"
                                                                src="{{ asset('images/product-image/102_1.jpg') }}" alt="Product" />
                                                        </a>
                                                        <div class="ec-pro-actions">
                                            ...
                                            <div class="ec-product-inner">
                                                <div class="ec-pro-image-outer">
                                                    <div class="ec-pro-image">
                                                        <a href="product-left-sidebar.html" class="image">
                                                            <img class="main-image"
                                                                src="{{ asset('images/product-image/103_1.jpg') }}" alt="Product" />
                                                            <img class="hover-image"
                                                                src="{{ asset('images/product-image/103_1.jpg') }}" alt="Product" />
                                                        </a>
                                                        <div class="ec-pro-actions">
                                            ...
                                            <div class="ec-product-inner">
                                                <div class="ec-pro-image-outer">
                                                    <div class="ec-pro-image">
                                                        <a href="product-left-sidebar.html" class="image">
                                                            <img class="main-image"
                                                                src="{{ asset('images/product-image/105_1.jpg') }}" alt="Product" />
                                                            <img class="hover-image"
                                                                src="{{ asset('images/product-image/105_2.jpg') }}" alt="Product" />
                                                        </a>
                                                        <div class="ec-pro-actions">
                                                            <a class="ec-btn-group wishlist" title="Wishlist"><img
                                                                    src="{{ asset('images/icons/pro_wishlist.svg') }}"
                                            ...
                                            <div class="ec-product-inner">
                                                <div class="ec-pro-image-outer">
                                                    <div class="ec-pro-image">
                                                        <a href="product-left-sidebar.html" class="image">
                                                            <img class="main-image"
                                                                src="{{ asset('images/product-image/106_1.jpg') }}" alt="Product" />
                                                            <img class="hover-image"
                                                                src="{{ asset('images/product-image/106_2.jpg') }}" alt="Product" />
                                                        </a>
                                                        <span class="flags">
                                                            <span class="sale">Sale</span>
                                                        </span>
                                            ...
                                            <div class="ec-product-inner">
                                                <div class="ec-pro-image-outer">
                                                    <div class="ec-pro-image">
                                                        <a href="product-left-sidebar.html" class="image">
                                                            <img class="main-image"
                                                                src="{{ asset('images/product-image/109_1.jpg') }}" alt="Product" />
                                                            <img class="hover-image"
                                                                src="{{ asset('images/product-image/109_1.jpg') }}" alt="Product" />
                                                        </a>
                                                        <span class="flags">
                                            ...
                                            <div class="ec-product-inner">
                                                <div class="ec-pro-image-outer">
                                                    <div class="ec-pro-image">
                                                        <a href="product-left-sidebar.html" class="image">
                                                            <img class="main-image"
                                                                src="{{ asset('images/product-image/112_1.jpg') }}" alt="Product" />
                                                            <img class="hover-image"
                                                                src="{{ asset('images/product-image/112_1.jpg') }}" alt="Product" />
                                                        </a>
                                                        <div class="ec-pro-actions">
